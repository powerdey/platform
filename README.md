...
| Admin    | http://localhost:4202 | http://localhost:5005                          | https://powerdey.web.app     |
...
Libraries are shareable across libraries and applications. They can be imported from `@powerdey/mylib`.
